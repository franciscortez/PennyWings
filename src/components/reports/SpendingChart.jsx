      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-xl font-black text-gray-900 tracking-tight">Income vs. Expense</h3>
          </div>
          <p className="text-sm font-medium text-gray-400 italic shrink-0">Daily cash flow trajectory</p>
        </div>
